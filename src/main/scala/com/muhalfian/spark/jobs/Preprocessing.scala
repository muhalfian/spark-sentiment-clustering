...
object Preprocessing extends StreamUtils {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val tweetsDF = SparkSession.read.json("/home/blade1/chandra_training.json")
...
labeledTweetsDf.coalesce(2).write.format("json").save("/home/blade1/chandra_training_res.json")
